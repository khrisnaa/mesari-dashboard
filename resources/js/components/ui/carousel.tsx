...
function useDotButton(api: CarouselApi | undefined) {
  ...
  const onInit = React.useCallback((embla: CarouselApi | undefined) => {
    if (!embla) return
    setScrollSnaps(embla.scrollSnapList())
  }, [])

  const onSelect = React.useCallback((embla: CarouselApi | undefined) => {
    if (!embla) return
...
function CarouselDots({ className, childClassName, ...props }: CarouselDotsProps) {
