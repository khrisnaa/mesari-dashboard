...
class StoreCustomizationRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'custom_details.*.mockup_image_base64.required' => 'The mockup image is required.',
            'custom_details.*.mockup_image_base64.string' => 'The mockup image must be a valid string.',
